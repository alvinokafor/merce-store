...
export default function SidebarContent({ setMobileMenuOpen, currentPath}) {
  ...
  return (
    <div>
      <div className="px-6 font-semibold space-y-2 text-sonic-silver mt-6">
        ...
        <div id="menu-item" className={currentPath === '' ? "menu-item-active group" : 'menu-item group'}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <path
              className={currentPath === '' ? 'fill-white' : "group-hover:fill-white"}
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <Link to='/'>
          <p onClick={changeLinkHandler} className={currentPath === '' ? "text-white" : "group-hover:text-white"}>Home</p>
          </Link>
        </div>
        ...
        <aside>
          ...
          <div id="menu-item" className={currentPath === 'products' ? "menu-item-active group" : 'menu-item group'}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <path
                className={currentPath === 'products' ? 'fill-white' : "group-hover:fill-white"}
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <Link to='/products'>
              <p onClick={changeLinkHandler} className={currentPath === 'products' ? "text-white" : "group-hover:text-white"}>Products</p>
              </Link>
          ...
          {productSubMenu && (
            <div className="flex flex-col w-4/6 ml-9">
              <Link to='/products/drafts'><p className="menu-item hover:text-white">Drafts</p></Link>
              <Link to='/products/released'><p className="menu-item hover:text-white">Released</p></Link>
            </div>
          )}
        </aside>
        ...
        <aside>
          ...
          <div id="menu-item" className={currentPath === 'customers' ? "menu-item-active group" : 'menu-item group'}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <path
                className={currentPath === 'customers' ? "fill-white" : "group-hover:fill-white"}
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <Link to='/customers'>
              <p onClick={changeLinkHandler} className={currentPath === 'customers' ? "text-white" : "group-hover:text-white"}>Customers</p>
              </Link>
          ...
          {customerSubMenu && (
            <div className="flex flex-col w-4/6 ml-9">
              <Link to='/customers/customer-list'><p className="menu-item hover:text-white">Customer list</p></Link>
            </div>
          )}
        </aside>
        ...
        <aside>
          ...
          <div id="menu-item"  className={currentPath === 'income' ? "menu-item-active group" : 'menu-item group'}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <path
                className={currentPath === 'income' ? "fill-white" : "group-hover:fill-white"}
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <div className="flex w-5/6 justify-between">
            <Link to='/income'>
              <p onClick={changeLinkHandler} className={currentPath === 'income' ? "text-white" : "group-hover:text-white"}>Income</p>
              </Link>
          ...
          {incomeSubMenu && (
            <div className="flex flex-col w-4/6 ml-9">
              <Link to='/income/payouts'><p className="menu-item hover:text-white">Payouts</p></Link>
            </div>
          )}
        </aside>
      </div>
