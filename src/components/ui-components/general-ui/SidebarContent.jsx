    ...
    <div>
      <div className="px-6 font-semibold space-y-2 text-sonic-silver mt-6">
        <div
          id="menu-item"
          className={
            currentPath === "" ? "menu-item-active group" : "menu-item group"
          }
        >
          <svg
            width="24"
          ...
          >
            <path
              className={
                currentPath === "" ? "fill-white" : "group-hover:fill-white"
              }
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <Link to="/">
            <p
              ...
              className={
                currentPath === "" ? "text-white" : "group-hover:text-white"
              }
            >
              Home
            </p>
        ...
        <aside>
          ...
          {productSubMenu && (
            <div className="flex flex-col w-4/6 ml-9">
              <Link to="/products/drafts">
                <p className="menu-item hover:text-white">Drafts</p>
              </Link>
              <Link to="/products/released">
        ...
        <aside>
          ...
          {customerSubMenu && (
            <div className="flex flex-col w-4/6 ml-9">
              <Link to="/customers/customer-list">
