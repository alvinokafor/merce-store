...
import SectionTitle from "../../components/ui-components/general-ui/SectionTitle"
import CustomerSearch from "../../components/ui-components/customers-ui/CustomerSearch"
import CustomerTable from "../../components/modules/customers/CustomerTable"
import CustomersMobileItem from "../../components/ui-components/customers-ui/CustomersMobileItem"
    ...
    <PageWrapper>
      ...
      <div className="mx-6 flex justify-between items-center md:mb-8">
        <div className="flex gap-x-6">
          <SectionTitle titleText="Customer List" titleColor="bg-lavender-blue" />
      ...
      <div className="space-y-5 md:hidden mx-6 my-8">
